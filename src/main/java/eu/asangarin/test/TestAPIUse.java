...
public class TestAPIUse {
	...
	public static void test(Player player) {
		...
		MythicHUDPlugin.get().getHandler().sendInstance(player, i("byebyetext"), new TextInstance(createText("Mega Cool Text")), 150, 150);
		// Just to remove it again, cuz that's needed.
		MythicHUDPlugin.get().getHandler().removeInstance(player, i("byebyetext"));
	}
